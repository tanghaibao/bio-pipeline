...
#ifndef PARSER_PACKAGE
/** @brief the program name (used for printing errors) */
#define PARSER_PACKAGE "gbs_digest"
#endif

#ifndef PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define PARSER_PACKAGE_NAME "gbs_digest"
#endif
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 * @deprecated use parser_ext() instead
 */
int parser2 (int argc, char **argv,
  struct args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int parser_ext (int argc, char **argv,
  struct args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int parser_file_save(const char *filename,
  struct args_info *args_info);

/**
 * Print the help
 */
void parser_print_help(void);
/**
 * Print the version
 */
 ...
 */
void parser_params_init(struct parser_params *params);

/**
 * Allocates dynamically a parser_params structure and initializes
 * all its fields to their default values
 * @return the created and initialized parser_params structure
 */
struct parser_params *parser_params_create(void);
 ...
 */
void parser_init (struct args_info *args_info);
/**
 * Deallocates the string fields of the args_info structure
 * (but does not deallocate the structure itself)
 * @param args_info the structure to deallocate
 */
void parser_free (struct args_info *args_info);
 ...
 * @return
 */
int parser_required (struct args_info *args_info,
